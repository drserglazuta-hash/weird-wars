...
export function EnemyArt({ id, className, title }: EnemyArtProps) {
  ...
  const drawing = (() => {
    switch (id) {
      ...
      case "wax-gnawer":
        return <><path d="M18 44c6-16 30-24 52-21 24 3 40 15 40 33 0 20-24 34-49 33S12 68 18 44Z" fill={red} stroke={ink} strokeWidth="4" {...common}/><path d="M32 62h58l-7 12-8-8-8 10-8-10-8 9-8-9Z" fill={paper} stroke={ink} strokeWidth="3" {...common}/><circle cx="47" cy="43" r="6" fill={paper}/><circle cx="76" cy="41" r="6" fill={paper}/><circle cx="49" cy="45" r="2.5" fill={ink}/><circle cx="78" cy="43" r="2.5" fill={ink}/><path d="m24 86 8 16m28-12 3 18m26-22 10 16" stroke={red} strokeWidth="7" {...common}/></>;
      case "dune-crusher":
      ...
      case "page-tearer":
        return <><path d="M14 96 26 18l24 8 16-12 20 14 22-6-8 80-30-8-22 10-28-8Z" fill={paper} stroke={ink} strokeWidth="4" {...common}/><path d="M30 24 40 52 24 62l18 12-12 22M92 22 80 50l16 12-18 12 10 22" stroke={ink} strokeWidth="4" strokeDasharray="7 5" {...common}/><path d="M56 30 46 60l20 6-14 30" stroke={red} strokeWidth="6" {...common}/><circle cx="48" cy="70" r="6" fill={ink}/><circle cx="78" cy="68" r="6" fill={ink}/><path d="M46 88c12 9 26 8 36-3" stroke={ink} strokeWidth="4" {...common}/></>;
      case "great-stain":
