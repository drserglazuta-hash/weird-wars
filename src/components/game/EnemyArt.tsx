...
export function EnemyArt({ id, className, title }: EnemyArtProps) {
  ...
  const drawing = (() => {
    switch (id) {
      ...
      case "ink-blob-boss":
        return <><path d="M22 74C6 58 17 27 43 26c9-19 40-18 47 4 24 6 27 35 10 47-14 10-63 12-78-3Z" fill={ink}/><path d="M30 82 20 104M60 88l-3 24M92 80l14 22M34 30 22 12M88 27 103 9" stroke={ink} strokeWidth="9" {...common}/><circle cx="48" cy="52" r="9" fill={paper}/><circle cx="74" cy="49" r="9" fill={paper}/><circle cx="51" cy="54" r="3.5" fill={ink}/><circle cx="77" cy="51" r="3.5" fill={ink}/><path d="M45 72c12 9 26 8 36-3" stroke={paper} strokeWidth="4" {...common}/></>;
      case "pond-queen":
        return <><ellipse cx="60" cy="78" rx="52" ry="24" fill={ink} opacity=".3"/><path d="M24 76C10 60 22 33 46 33c8-17 38-16 45 4 22 6 24 32 8 42-13 9-60 11-75-3Z" fill={ink}/><path d="m43 22 6-16 8 15 9-17 7 18 10-14 2 17" stroke={ink} strokeWidth="6" {...common}/><circle cx="48" cy="57" r="8" fill={paper}/><circle cx="75" cy="55" r="8" fill={paper}/><circle cx="50" cy="59" r="3" fill={ink}/><circle cx="77" cy="57" r="3" fill={ink}/><path d="M8 92c18 8 40 10 62 4s34-4 44 2" stroke={ink} strokeWidth="4" opacity=".5" {...common}/></>;
      case "wax-gnawer":
        return <><path d="M18 44c6-16 30-24 52-21 24 3 40 15 40 33 0 20-24 34-49 33S12 68 18 44Z" stroke={ink} strokeWidth="4" {...common} fill={red}/><path d="M32 62h58l-7 12-8-8-8 10-8-10-8 9-8-9Z" stroke={ink} strokeWidth="3" {...common} fill={paper}/><circle cx="47" cy="43" r="6" fill={paper}/><circle cx="76" cy="41" r="6" fill={paper}/><circle cx="49" cy="45" r="2.5" fill={ink}/><circle cx="78" cy="43" r="2.5" fill={ink}/><path d="m24 86 8 16m28-12 3 18m26-22 10 16" stroke={red} strokeWidth="7" {...common}/></>;
      case "dune-crusher":
        return <><ellipse cx="61" cy="63" rx="48" ry="34" fill={pink} stroke={ink} strokeWidth="4"/><path d="M22 50c26-12 54-12 78 2M18 76c28 12 58 10 84-4" stroke={ink} strokeWidth="3" opacity=".6" {...common}/><circle cx="46" cy="56" r="7" fill={paper} stroke={ink} strokeWidth="2"/><circle cx="78" cy="55" r="7" fill={paper} stroke={ink} strokeWidth="2"/><circle cx="48" cy="58" r="3" fill={ink}/><circle cx="80" cy="57" r="3" fill={ink}/><path d="M44 76c11 8 24 8 34-1" stroke={ink} strokeWidth="4" {...common}/><path d="m10 100 9-6m14 12 7-8m62 6 8-7m10-9 8-5" stroke={pink} strokeWidth="6" {...common}/></>;
      case "fog-lord":
        return <><ellipse cx="60" cy="62" rx="52" ry="36" fill={pencil} opacity=".18"/><path d="M14 60c14-26 40-38 60-28 22 11 30 34 22 50-9 17-42 20-63 8-13-8-22-19-19-30Z" fill={pencil} opacity=".32"/><path d="M8 46c26-14 52 12 82-6M10 78c30 16 58-10 86 4" stroke={pencil} strokeWidth="8" opacity=".35" {...common}/><ellipse cx="49" cy="56" rx="8" ry="6" fill="var(--eye-glow)"/><ellipse cx="76" cy="54" rx="8" ry="6" fill="var(--eye-glow)"/><circle cx="51" cy="57" r="3" fill={ink}/><circle cx="78" cy="55" r="3" fill={ink}/></>;
      case "page-tearer":
        return <><path d="M14 96 26 18l24 8 16-12 20 14 22-6-8 80-30-8-22 10-28-8Z" stroke={ink} strokeWidth="4" {...common} fill={paper}/><path d="M30 24 40 52 24 62l18 12-12 22M92 22 80 50l16 12-18 12 10 22" stroke={ink} strokeWidth="4" strokeDasharray="7 5" {...common}/><path d="M56 30 46 60l20 6-14 30" stroke={red} strokeWidth="6" {...common}/><circle cx="48" cy="70" r="6" fill={ink}/><circle cx="78" cy="68" r="6" fill={ink}/><path d="M46 88c12 9 26 8 36-3" stroke={ink} strokeWidth="4" {...common}/></>;
      case "great-stain":
